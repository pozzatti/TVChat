...
public class Facebook {
    ...
    /**
     * Helper to validate a br.com.tvchat.service intent by resolving and checking the
     * provider's package signature.
     * 
     * @param context
     * @param intent
     * @return true if the br.com.tvchat.service intent resolution happens successfully and
    ...
    /**
     * Handles connection to the token refresh br.com.tvchat.service (this br.com.tvchat.service is a part
     * of Facebook App).
     */
        ...
        public void handleMessage(Message msg) {
            ...
            if (token != null) {
                ...
                if (msg.getData().containsKey("error_code")) {
                    ...
                    connection.serviceListener.onError(new Error(error != null ? error : "Unknown br.com.tvchat.service error"));
                }
            }
    ...
    /**
     * Callback interface for br.com.tvchat.service requests.
     * <p/>
     * THIS CLASS SHOULD BE CONSIDERED DEPRECATED.
     * <p/>
     * All public members of this class are intentionally deprecated.
    ...
    public static interface ServiceListener {
        ...
        /**
         * Called when a br.com.tvchat.service request completes.
         * 
         * @param values
         *            Key-value string pairs extracted from the response.
         */
