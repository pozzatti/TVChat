...
/**
 * This class represents an access token returned by the Facebook Login br.com.tvchat.service, along with associated
...
public final class AccessToken implements Serializable {
     ...
     * list of permissions is maintained by the Facebook br.com.tvchat.service, so this list may be outdated if
     ...
     * maintained by the Facebook br.com.tvchat.service, so this list may be outdated if permissions have been granted or declined
