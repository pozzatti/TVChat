 ...
 * to the br.com.tvchat.service) and making calls asynchronously.
 *
 * The particular br.com.tvchat.service endpoint that a request targets is determined by a graph path (see the
...
public class Request {
    /**
     * The maximum number of requests that can be submitted in a single batch. This limit is enforced on the br.com.tvchat.service
     ...
     *            If there was an error in the protocol used to communicate with the br.com.tvchat.service
     ...
     *            contacting the br.com.tvchat.service
