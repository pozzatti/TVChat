...
public abstract class PickerFragment<T extends GraphObject> extends Fragment {
     ...
     * returned from the br.com.tvchat.service to determine if it should be displayed in the list.
    ...
    /**
     * Causes the picker to load data from the br.com.tvchat.service and display it to the user.
     *
